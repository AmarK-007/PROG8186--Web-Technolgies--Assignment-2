...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 12, 2024 at 03:45 AM
...
(22, 11, '/images/new-shoe-1.jpg'),
(23, 11, '/images/new-shoe-2.jpg'),
(24, 12, '/images/new-shoe-1.jpg'),
(25, 12, '/images/new-shoe-2.jpg'),
(33, 10, '/images/new-shoe-3.jpg'),
(34, 10, '/images/new-shoe-2.jpg');
...
INSERT INTO `products` (`product_id`, `title`, `description`, `price`, `shipping_cost`, `is_deleted`) VALUES
(1, 'Air Tennis Shoe', 'White Blue coloured Shoe for Men provides cushioning and support effect for the feet with Non Slip Sport Tennis, Gym, Walking Shoes Sneakers.', 46.99, 0.00, 0),
(2, 'Air Running Shoe', 'Red coloured Shoe for Men extremely lightweight running shoes great for running, walking, fitness, jogging, outdoor sports, workout, and hiking.', 56.99, 0.00, 1),
(3, 'Air Walking Shoe', 'Yellow coloured Arch Support Designed shoes have good arch support with the memory foam insole and cloudfoam cushioning perfect for long walking.', 44.99, 0.00, 0),
(4, 'Air Athletic Shoe', 'Black coloured unisex shoe with double layered knitted fabric, which is lightweight, breathable and comfortable, keep your feet dry and cool.', 55.99, 0.00, 0),
(5, 'Air Casual Shoe', 'Grey coloured unisex sneakers made from ultra light natural rubber material, flexible grooves, anti-skid and grip, adapts to any road condition', 40.99, 0.00, 0),
(10, 'New Tennis Shoe', 'New Shoe Description', 99.99, NULL, 0),
(11, 'New Tennis Shoe', 'New Shoe Description', 50.99, NULL, 0),
(12, 'New Tennis Shoe', 'New Shoe Description', 50.99, NULL, 0);
...
--
ALTER TABLE `productsizes`
  MODIFY `size_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=81;
